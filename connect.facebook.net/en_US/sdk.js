...
(function _(e, t, n, r, o, a, i) {
  try {
    ...
    if (
      (l &&
        Math.floor(new Date().getTime() / 1e3) - t > 10080 * 60 &&
        l.warn("The Facebook JSSDK is more than 7 days old."),
      window[n] || !window.JSON)
    )
      return;
    for (
      var s = (window[n] = {
          ...
          init: function (e) {
            ("fbAsyncInit" in window) || (s.__buffer.opts = e);
          },
        }),
        u = 0;
      u < r.length;
      ...
      var c = r[u];
      if (!(c in s)) {
        for (var d = c.split("."), m = d.pop(), p = s, f = 0; f < d.length; f++)
          p = p[d[f]] || (p[d[f]] = {});
        p[m] = (function (e) {
          if (e !== "init")
            return function () {
    ...
    (g.src = e),
      ...
      g.addEventListener("load", function () {
        window.FB_LOCAL_GLOBAL.require
          .call(null, "sdk.dynamic-module-loader")
          .load(a);
      }),
    ...
    (L.src = R + "?c=jssdk_error&m=" + k),
      (y = document.body) == null || y.appendChild(L);
  }
})(
    ...
    JSSDKConfig: {
      features: {
        ...
        allow_shadow_dom_for_apps_with_id: [
          520916077950649, 152351391599356, 132081130190180, 468663283258845,
          409976882430412, 189845245141894, 360467581347, 274266067164,
        ],
