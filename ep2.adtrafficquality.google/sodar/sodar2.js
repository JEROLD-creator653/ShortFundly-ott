(function () {
  ...
  function w(a, b, c) {
    if (b)
      a: {
        ...
        b != null &&
          (a
            ? k(q, d, { configurable: !0, writable: !0, value: b })
            : b !== c &&
              (t[d] === void 0 &&
                ((a = (Math.random() * 1e9) >>> 0),
                (t[d] = p ? l.Symbol(d) : "$jscp$" + a + "$" + d)),
              k(g, t[d], { configurable: !0, writable: !0, value: b })));
      }
  }
  var x;
  ...
  var ia =
    p && typeof u(Object, "assign") == "function"
      ? u(Object, "assign")
      : function (a, b) {
  ...
  D.prototype.ca = function (a, b) {
    ...
    (b = this.i = this.i || b)
      ? b.W
        ? (this.g = this.A || this.m)
        : b.v != void 0 && this.m < b.v
        ? ((this.g = b.v), (this.i = null))
        : (this.g = this.m)
      : (this.g = a);
  };
  ...
  w(
    ...
    function (a) {
      ...
      function c(g, e) {
        this.g = g;
        k(this, "description", { configurable: !0, writable: !0, value: e });
      }
      if (a) return a;
  ...
  w(
    ...
    function (a) {
      ...
      b.prototype.j = function () {
        ...
        var h = this,
          m = !1;
        return { resolve: e(this.H), reject: e(this.m) };
      };
      ...
      b.prototype.C = function () {
        ...
        typeof e === "function"
          ...
          : ((e = l.document.createEvent("CustomEvent")),
      ...
      b.race = function (e) {
        return new b(function (h, m) {
          for (var n = B(e), r = n.next(); !r.done; r = n.next())
            d(r.value).M(h, m);
        });
      };
      b.all = function (e) {
...
*/
  ...
  function wa(a, b) {
    ...
    return new q.Promise(function (d, f) {
      ...
      va(e, a);
      c && b.document.readyState !== "complete"
        ? O(b, "load", function () {
  ...
  function P(a, b, c, d) {
    ...
    this.o = c === void 0 ? 0 : c;
    this.i = (d === void 0 ? 0 : d)
      ? N(Aa, encodeURIComponent(a))
      : N(Ba, encodeURIComponent(a));
  }
  function Ca(a) {
    return J(function (b) {
      switch (b.g) {
  ...
  function Ea(a) {
    return new q.Promise(function (b, c) {
      a.h.botguard && a.h.botguard.bg
        ? (a.g = new a.h.botguard.bg(a.U, b))
        : c(5);
    });
  }
  ...
  function Ga() {
    ...
    if (a && a.length > 0 && (a = a.shift())) {
      ...
      a._rc_ !== void 0 &&
        (b = u(Object, "assign").call(Object, {}, b, { S: a._rc_ }));
      a._wvp_ !== void 0 &&
        (b = u(Object, "assign").call(Object, {}, b, { D: T(a._wvp_) }));
      return b;
    }
  }
  function Ha() {
  ...
  function La(a, b) {
    ...
    return J(function (d) {
      ...
      if (d.g != 2) return (c = d.j), d.return({ response: c[0], error: c[1] });
      d.F();
      return d.return({ error: 9 });
    });
  }
  function Ma() {
...
*/
    ...
    if (b) {
      var g = function (e) {
        ...
        typeof f.removeEventListener === "function" &&
          f.removeEventListener("load", g, !1);
        typeof f.removeEventListener === "function" &&
  ...
  function Pa(a) {
    this.url = (this.l = a)
      ? "https://ep1.adtrafficquality.google/pagead/gen_204?id=sodar2&v=254"
      : "https://pagead2.googlesyndication.com/pagead/gen_204?id=sodar2&v=254";
  }
  function V(a, b, c) {
  ...
  function Qa(a, b, c) {
    ...
    (c !== !1 && f) ||
      (d.url = d.l
        ? "https://ep1.adtrafficquality.google/pagead/sodar?id=sodar2&v=254"
        : "https://pagead2.googlesyndication.com/pagead/sodar?id=sodar2&v=254");
    V(d, "t", a);
    b &&
      (V(d, "li", b.T),
      V(d, b.context === "cr" && b.O === "int" ? "bgai" : "jk", b.N));
    return d;
  }
  function Ra(a) {
    return new q.Promise(function (b) {
  ...
  function Xa(a) {
    var b = 0;
    a.mediaIntegrityErrorName
      ? b || (b = Ta[a.mediaIntegrityErrorName])
      : a.code && (b = a.code());
    return b;
  }
  function Za() {
    ...
    return J(function (b) {
      if (b.g == 1) {
        ...
        if (bb(a)) var d = db(a);
          ...
          (a.g = new P(a.config.L, a.config.K, a.o, a.config.l)), (d = Ca(a.g));
        return c.call(b, d, 2);
      }
      a.j = b.j;
      ...
      switch (f.g) {
        ...
        case 3:
          return (
            (d = Date.now() - b),
            c.Y
              ? f.h(Sa(a.config, void 0, c.Y, d), 0)
              : c.X
              ? f.h(
                  W(
                    16,
                    a.config,
                    "ftpe=" + String(Y().g) + ",ptb=" + String(c.X),
                    d
                  ),
                  0
                )
              : f.h(W(18, a.config, "ftpe=" + String(Y().g), d), 0)
          );
      }
    });
  }
  function fb(a, b) {
    function c(g) {
      g &&
        g.data !== null &&
        g.origin === "https://www.google.com" &&
        g.source != null &&
        g.source === b.contentWindow &&
        ((a.h = "id=sodar2&v=254"),
        a.config &&
          ((a.h += "&li=" + encodeURIComponent(a.config.T.toString())),
          (a.h +=
            "&" +
            (a.config.context === "cr" ? "bgai" : "jk") +
            "=" +
            encodeURIComponent(a.config.N.toString())),
          g.source.postMessage(
            JSON.stringify({ id: "sodar", params: a.h }),
  ...
  function hb(a) {
    return J(function (b) {
      return b.h(
        u(q.Promise, "allSettled").call(q.Promise, [cb(a), gb(a), eb(a)]),
        0
      );
    });
  }
  function bb(a) {
    return a.config.Z ||
      window.location.host ===
        (a.l ? "ep2.adtrafficquality.google" : "tpc.googlesyndication.com") ||
      a.config.O === "int"
      ? !1
      : !0;
  }
  function db(a) {
    ...
    return J(function (f) {
      ...
      if (f.g != 4) {
        ...
        var e = a.l;
        g = window.hasOwnProperty("MessageChannel")
          ? new Ja(g, e)
          : new Ma(g, e);
        a.i = g;
        return a.i.g
          ? ((g = a.config),
            ...
            f.return(void 0))
          : f.h(
              La(a.i, { fa: a.config.L, U: a.config.K, o: a.o, l: a.config.l }),
              4
            );
      }
      d = f.j;
