window.ox_esp = (function (t) {
  ...
  function (t, e, r) {
    var n = (function (t) {
      ...
      return (
        ...
        (h.constructor = l),
        (l.displayName = s(h, a, "GeneratorFunction")),
  ...
  function (t, e, r) {
        ...
        (this._initBody = function (t) {
          ...
          (this.bodyUsed = this.bodyUsed),
            ...
            t
              ? "string" == typeof t
                ? (this._bodyText = t)
                : f && Blob.prototype.isPrototypeOf(t)
                ? (this._bodyBlob = t)
                : p && FormData.prototype.isPrototypeOf(t)
                ? (this._bodyFormData = t)
                : u && URLSearchParams.prototype.isPrototypeOf(t)
                ? (this._bodyText = t.toString())
                : l && f && (e = t) && DataView.prototype.isPrototypeOf(e)
                ? ((this._bodyArrayBuffer = _(t.buffer)),
                  (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                : l && (ArrayBuffer.prototype.isPrototypeOf(t) || d(t))
                ? (this._bodyArrayBuffer = _(t))
    ...
    function L(t, e) {
      return new Promise(function (r, n) {
        ...
        (i.onload = function () {
          ...
          !e || "object" != typeof e.headers || e.headers instanceof g
    ...
    (L.polyfill = !0),
      s.fetch ||
        ((s.fetch = L), (s.Headers = g), (s.Request = A), (s.Response = T));
    r(2);
    var B = r(4),
      U = r.n(B),
      I = r(5),
    ...
    var N = { resourceId: "esp", logging: "error", identityLink: !1 };
    function G(t, e) {
      var r = (function (t) {
        ...
        return (
          (t[e] = function () {
            ...
            if (n && console && "function" == typeof console[t]) {
              ...
              if (!0 === n || (o > -1 && r >= o)) {
                for (
                  var i, a = arguments.length, s = new Array(a), u = 0;
                  u < a;
                  u++
                )
                  s[u] = arguments[u];
                ...
                (i = console)[t].apply(
                  i,
                  ["".concat(e.toUpperCase(), " - (ox_esp) ").concat(f)].concat(
                    U()(p)
                  )
                );
              }
                ...
                case 0:
                  ...
                  return (
                    (e = new Promise(function (t, e) {
                      window.__uspapi
                        ? ($.debug("US Privacy library is present"),
                          __uspapi("getUSPData", 1, function (r, n) {
                            n
                              ? K(r.uspString)
                                ? t()
                                : ($.debug("User has not given consent."),
                                  e(!1))
                              : e();
                          }))
                        : t();
                    ...
                    (r = new Promise(function (t, e) {
                      window.__tcfapi
                        ? ($.debug("TCFAPI library is present"),
                          window.__tcfapi(
                            "getTCData",
                            2,
                            function (r, n) {
                              n
                                ? !r.gdprApplies ||
                                  (r.vendor.consents[69] &&
                                    r.purpose.consents[1])
                                  ? t()
                                  : ($.debug("User has not given consent."),
                                    e(!1))
                                : e();
                    ...
                    (n = new Promise(function (t, e) {
                      window.__cmp
                        ? ($.debug("CMP library is present"),
                          window.__cmp("getVendorConsents", [69], function (r) {
                            !r.gdprApplies ||
                            (!0 === r.vendorConsents[69] &&
                              !0 === r.purposeConsents[1])
                              ? t()
                              : ($.debug("User has not given consent."), e(!1));
                          }))
                        : t();
                    })),
                    (H = Promise.all([e, n, r])
    ...
    function K(t) {
      ...
      return (
        "Y" !== e &&
        ("N" === e
          ? $.debug("User gave consent")
          : "-" === e && $.debug("CCPA doesnt apply to this user"),
        !0)
      );
    }
    function Q() {
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 4:
                  ...
                  return (
                    (t.next = 8),
                    window.ats.retrieveEnvelope().then(function (t) {
                ...
                case 9:
                  return (
                    (e = t.t0),
                    (r = "?url=" + encodeURIComponent(tt())),
                    (r = V.resourceId ? r + "&rid=" + V.resourceId : r),
                    (r = e ? r + "&env=" + e : r),
                    (t.next = 15),
                    fetch("https://oajs.openx.net/esp" + r, {
                      method: "GET",
                      credentials: "include",
                    })
                      .then(function (t) {
    ...
    function Z(t) {
      if (0 != t) {
        var e =
            "<iframe src='https://google-bidout-d.openx.net/w/1.0/pd?plm=" +
            (t || 5) +
    ...
    var et = document.currentScript.getAttribute("data-ox-plm") || 5,
      rt = {
        ...
        logging: document.currentScript.getAttribute("data-ox-debug")
          ? "debug"
          : "error",
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 7:
                  return (
                    (X = t.sent),
                    $.debug("getESPId: calling OX:", X.esp),
                    Z(et),
                    t.abrupt("return", X.esp)
                  );
                case 13:
                  return (
                    $.debug("getESPId: grabbing from cache:", X.esp),
                    t.abrupt("return", X.esp)
                  );
                case 15:
                  t.next = 18;
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 7:
                  return (
                    (X = t.sent),
                    $.debug("getOAIds: calling OX:", X),
                    t.abrupt("return", X)
                  );
                case 12:
                  return (
                    $.debug("getOAIds: grabbing from cache:", X),
                    t.abrupt("return", X)
                  );
                case 14:
                  t.next = 17;
