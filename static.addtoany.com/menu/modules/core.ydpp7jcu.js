...
let A = navigator.userAgent,
  R = A.match(/Mobi|iPhone|iPad|iPod|Android/),
  $ = "ontouchend" in J,
  ue = () => {
    let e;
    var a = "share1";
          ...
          (e =
            (e =
              Z.native && navigator.share
                ? (e = -1 < A.indexOf("Mac") && a) ||
                  (-1 < A.indexOf("CrOS") && "share2")
                : e) ||
            (!!/iPhone|iPad|iPod/.test(A) && a)) ||
          (!!(-1 < A.indexOf("Mac") && $) && a)) ||
        (!!/Android/i.test(A) && "share2")),
      (ue = () => e),
      e
    );
  },
  ...
  ae =
    ((ce = H.page.most.concat(H.feed.most)).forEach((e) => i.push(e[2])),
    {
      apple_music: {
        name: "Apple Music",
        icon: "apple_music",
...
for (var a in ae) i.push(ae[a].icon);
function r(a) {
  l(function (e) {
...
let k = (e) => setTimeout(e, 0),
    ...
    ready: function (e) {
      ...
      function t() {
        K.removeEventListener("DOMContentLoaded", o, !1),
          J.removeEventListener("load", o, !1);
      }
      let o = function (e) {
        (!K.addEventListener &&
          "load" !== e.type &&
  ...
  te = function (e, a = {}) {
    ...
    var t,
      ...
      p = {},
      u = location.href;
    for (t in (fa(e), a)) s[t] = a[t];
    for (t in s) c[t] = s[t];
    if ((o = s.target))
      if ("string" == typeof o) {
        if (((n = o.substring(0, 1)), (o = o.substring(1)), "." == n))
          return U(_e(f(o, K)), e, a), void (s.target = X);
        0 <= (n = (d = b(o)).className).indexOf("a2a_kit") &&
    ...
    (p.type = y),
      ...
      (p.linkname_implicit =
        !s.linkname_escape && (K.title || u) == p.linkname),
      ...
      d
        ? (o.linkname_escape &&
            (i =
              f("a2a_linkname_escape", d.parentNode)[0] ||
              f("a2a_linkname_escape", d.parentNode.parentNode)[0]) &&
            (o.linkname = i.textContent),
          (o.linkmedia = n.linkmedia = e || o.linkmedia),
          (o.linkname = n.linkname = r || o.linkname),
          (o.linkurl = n.linkurl = l || o.linkurl),
          r && (o.linkname_implicit = !1),
          l && (o.linkurl_implicit = !1),
          (p.textContent = o.linkname),
          (i = p.childNodes[0]) && (o.linkname = i.nodeValue),
          d.a2a_kit ? Y(o, n) : q(o))
        : u.show_menu || M--,
      G();
  },
  U = function (e, a, t) {
    for (var o = 0, n = e.length; o < n; o++) (t.target = e[o]), te(a, t);
  },
  W = (e) => {
    var e = "a2a" + e,
      a = Z.onclick,
  ...
  q = function (n) {
      ...
      s =
        ...
        () => {
          ...
          a
            ? v("none", r)
            : (!W(r) && "mail" != r) ||
              (S(i), (Q[r].last_focus = n), e.focus()),
            t && (a || 2 === o) && "mail" != r && (E(), (Q[r].last_focus = n));
        }),
      c = !1,
      t,
      o = (e) => {
            ...
            (o = n),
              new Promise((e, a) => {
                ...
                .then((e) => {
                  let a;
                  try {
                    a = new URL(n).pathname.split(".").pop();
                  } catch (e) {}
        ...
        if (t || e || c)
          if (t && (e || c)) s();
            ...
            Ie(n);
            let a = { url: n.linkurl, text: n.linkname, files: [] };
            t = n.linkmedia;
            t
              ? o(t).then((e) => {
                  a.files.push(e), je(a, s);
                })
              : je(a, s);
          }
        else s();
    ...
    (i.getAttribute("onclick") &&
      ...
      ne(
        ...
        (e) => {
          ...
          (a.webkitTouchCallout = a.webkitUserSelect = "none"),
            (t = setTimeout(() => {
              (c = !0), o(e), (a.webkitTouchCallout = a.webkitUserSelect = "");
            }, 700));
        },
        !!h() && { passive: !0 }
      ),
      ...
      ne(i, "click", me),
      ne(i, "touchstart", me, !!h() && { passive: !0 }),
      Z.onclick) ||
      (Q[y].delay
      ...
      "a" == i.tagName.toLowerCase() &&
        ...
        (i.href =
          ...
          encodeURIComponent(n.linkurl) +
          "&title=" +
          encodeURIComponent(n.linkname).replace(/'/g, "%27"));
    e = i.firstChild;
    e &&
      void 0 !== e.srcset &&
  ...
  Y = (c, d) => {
    ...
    function h(e, a) {
      if (e && !ie(e, m))
        for (
          var t = 0,
            o = a ? Q[p].services.most.concat(Q[p].services.email) : ce,
            n = o.length;
          t < n;
          t++
        )
          if (e == o[t][1]) return o[t];
      return !a && [e, e];
    }
    var $ = oe.avail;
    function g(e, a) {
      for (var t, o = 0, n = e.attributes.length, i = a; o < n; o++)
    ...
    var P = "a2a_svg a2a_s__default a2a_s_",
      ...
      A = {},
      t = e["a2a-scroll-show"],
      C = 0 <= y.indexOf("a2a_vertical_style"),
    ...
    E &&
      ...
      (a &&
        "unset" != a &&
        (o && "unset" != o && (x.backgroundColor = o), w) &&
        "unset" != w.trim() &&
        (w = w.trim()),
      (v.style.lineHeight = A.height = A.lineHeight = e),
      (A.width = 2 * S + "px"),
      (A.fontSize = "16px"),
      C &&
        ((A.height = A.lineHeight = S / 2 + "px"),
        (A.fontSize = "10px"),
        (A.width = E + "px")),
      t && ve(v, t),
      32 != S) &&
      ((x.backgroundSize = x.height = x.lineHeight = x.width = e),
      (A.borderRadius = x.borderRadius = (0.14 * S).toFixed() + "px"),
      (A.fontSize = (parseInt(A.height, 10) + (C ? 4 : 0)) / 2 + "px"));
    let F = {
      facebook_like: function (t, o) {
        (f.href = c.linkurl),
          (f.width = "90"),
                ...
                r &&
                  ...
                  (e = (function () {
                    ...
                    if (e && -1 < e.indexOf("url=")) {
                      for (
                        var a = {}, t = e.split("&"), o = t.length, n = 0;
                        n < o;
                        n++
                      ) {
                        var i = t[n].split("=");
        ...
        "beside" == f["pin-config"] &&
          ...
          (i.href =
            ...
            (f.description
              ...
              : "")),
          ne(e, "click", function () {
            le.track("Pinterest Pin", "pinterest_pin", c.linkurl),
              s("Pinterest Pin", a, e);
          }),
          e.appendChild(i),
          F.pinterest_pin_script ||
            ((o = K),
            (n = o.createElement("script")),
            (o = o.getElementsByTagName("script")[0]),
            (n.async = !0),
            (n.src = "https://assets.pinterest.com/js/pinit.js"),
            o.parentNode.insertBefore(n, o)),
          (F.pinterest_pin_script = 1);
      },
      ...
      linkedin_share: function (e, a) {
        ...
        (F.linkedin_share_event = function () {
          le.track("LinkedIn Share", "linkedin_share", c.linkurl),
            s("LinkedIn Share", a, e);
        }),
          F.linkedin_share_script ||
            ((o = K),
            (n = o.createElement("script")),
            (o = o.getElementsByTagName("script")[0]),
            (n.type = "text/javascript"),
            (n.async = !0),
            (n.src = "https://platform.linkedin.com/in.js"),
            o.parentNode.insertBefore(n, o)),
          (F.linkedin_share_script = 1),
    ...
    for (let s = 0; s < n; s++) {
      var T = b[s],
        ...
        z = 0 <= B.indexOf("a2a_counter");
      let e = !!N && N[1];
      var M = T.childNodes,
        N = h(e),
        U = k && ae[e] ? ae[e].name : N[0];
      let a = "_blank",
        t = k && ae[e] ? ae[e].icon : N[2],
        o = k && ae[e] ? ae[e].color : N[3] || "CAE0FF";
      N[4];
      let n = !1,
        i = !1;
      ...
      if (
        ...
        L
          ? ((d.target = T),
            ...
            (t = "page" === p && D ? D : "a2a"),
            (i = z),
            0 <= y.indexOf("a2a_floating_style") && (T.a2a_floating = 1))
          : "feed" == e || "print" == e
          ? (a = "")
          : z && e && ie(e, $)
          ? (i = !0)
          : e && ie(e, m) && (F[e](T, e), (n = !0)),
        e && !ie(e, ["google_plus", "stumbleupon"]) && !n)
      ) {
        if (
          (L ||
            ((v.a2a_codes = v.a2a_codes || []),
            v.a2a_codes.push(e),
            (T.target = a),
            !k || (!ae[e] && h(e, !0))
              ? "feed" === e
                ? (T.href = T.href || c.linkurl)
                : se(da(N), T, c)
              : (T.href = (function (e, a) {
                  let t;
                  var o = g(e, {})["a2a-follow"],
                    a = ae[a];
                  return (
                    (t = o && a && a.url ? a.url.replace("${id}", o) : t) ||
                    e.href
                  );
                })(T, e))),
          M.length)
        ) {
          for (var I, W, q, O = 0, Y = M.length; O < Y; O++)
            if (
              ((q =
                (W = "string" == typeof (I = M[O].className)) &&
                ("a2a_label" === I || 0 <= I.indexOf("a2a_ignore"))),
              1 == M[O].nodeType &&
                (q || (l = !0), W) &&
                0 <= I.indexOf("a2a_count"))
            ) {
              r = !0;
              break;
            }
          if (!l) {
            for (var G in (((u = K.createElement("span")).className =
              P + t + " a2a_img_text"),
            o && !j && (u.style.backgroundColor = "#" + o),
            ia(t, u, w),
            x))
              u.style[G] = x[G];
            T.insertBefore(u, M[0]);
          }
        } else {
          for (var V in (((u = K.createElement("span")).className = P + t),
          o && !j && (u.style.backgroundColor = "#" + o),
          ia(t, u, w),
          x))
            u.style[V] = x[V];
          ...
          var D = U || ("feed" == p ? Z.localize.Subscribe : Z.localize.Share);
          (u.innerHTML = ee ? ee.createHTML(D) : D),
            U ||
        ...
        if ((i = C && E && S < 20 ? !1 : i) && !r) {
          for (var R in (((u = K.createElement("span")).className =
            "a2a_count"),
          (u.a2a = {}),
          (u.a2a.kit = v),
          A))
            (j && 0 <= ["width", "height"].indexOf(R)) || (u.style[R] = A[R]);
          T.appendChild(u);
          z = (
        ...
        o && j && (T.style.backgroundColor = "#" + o),
          "a2a_dd" != B && de.push(T);
      }
    }
    0 <= y.indexOf("a2a_default_style") &&
      ((i.style.clear = "both"), v.appendChild(i));
  },
  oe = {
    get: function (i, r, e, l) {
      ...
      var s,
        ...
        o = oe.bonus(i, t, e, r.a2a.kit),
        c = "",
        n = oe[i],
        d = n.api,
        p = (n.cb, r.a2a.is_a2a_dd_counter);
      !l && o && ((c = "2"), oe.get(i, r, o, !0)),
        "string" != typeof (s = n[t] = n[t] || {}).num || l
          ? "number" == typeof s.num
            ? p
              ? oe.sum(r, s.num, i + c)
              : oe.set(r, s.num, i + c)
              ...
              (n["cb" + n.n] = function (e) {
                ...
                if (void 0 !== t)
                  if ("string" == typeof t && "facebook" == i)
                    ...
                    for (var o, n = 0; n < s.queued.length; n++)
                      (o = s.queued[n]),
                        (s.num = t),
                        o.a2a.is_a2a_dd_counter
                          ? oe.sum(o, t, i + c)
                          : oe.set(o, t, i + c);
              }),
              1 == s.queued.length &&
    ...
    set: function (e, a, t) {
      ...
      (n.textContent = oe.format(a)),
        (e.textContent = ""),
        e.appendChild(n),
        "a2a" != t && ((e.a2a.last_count = o), oe.sum(e, o, t));
    },
    sum: function (e, a, t) {
      var e = e.a2a.kit,
        o = e.a2a_counts_sum || 0,
        n = e.a2a_counts_summed || [];
      "a2a" != t &&
        -1 === n.indexOf(t) &&
        ((o = e.a2a_counts_sum = o + a),
        (n = e.a2a_counts_summed = n || []).push(t)),
        e.a2a_dd_counter && oe.set(e.a2a_dd_counter, o, "a2a");
    },
    format: function (e) {
      var a = oe.format,
        t = "localize";
      ...
      return (
        r &&
          (r.recover_protocol &&
            ...
            ((n = t.replace(/^https%/, "http%")), (a = decodeURIComponent(n))),
          r.recover_domain &&
          ...
          (n = encodeURIComponent(r.recover(a)))),
        !(
          !n ||
          n === t ||
          (-1 !== ["tumblr"].indexOf(e) &&
            n.split(l).pop() === t.split(l).pop())
        ) && n
      );
    },
    ...
    reddit: {
      ...
      cb: function (e, a) {
        var t = e.data;
        if (e && t && t.children) {
          for (var o = [], n = t.children, i = 0; i < n.length; i++) {
            var r = n[i].data;
            r && !isNaN(r.ups) && o.push(r.ups);
          }
  ...
  G = function () {
    var e = Q[y],
      a = w;
    e.bookmarklet && ((e.no_hide = 1), (x = a), S()),
      e.show_menu &&
        ((e.no_hide = 1), (x = a), S(null, e.show_menu), (e.show_menu = X)),
      (G.a2a_done = 1);
  },
  l = function (i, e) {
    var a = f,
    ...
    function o(e) {
      for (var a, t, o = 0, n = e.length; o < n; o++)
        if (
          (t =
            (void 0 === (a = e[o]).a2a_index || "" === a.a2a_index) &&
  ...
  f = function (e, a, t) {
    for (
      var o,
        n = (a = a || b("a2a" + y + "_dropdown")).getElementsByClassName(e),
      ...
      (o = n[l]), (i && !i.test(o.nodeName)) || r.push(o);
    return r;
  },
  _e = function (e) {
    for (var a = [], t = e.length, o = 0; o < t; o++) a[a.length] = e[o];
    return a;
  };
e = (e) => {
  try {
...
let fe = function (e, a) {
  ...
  ne = function (e, a, t, o) {
    var n;
    return (
      "object" == typeof o && ((n = !!o.useCapture), (o = h() ? o : n)),
      e.addEventListener(a, t, o),
      {
        destroy: function () {
          e.removeEventListener(a, t, o);
        },
      }
    );
  },
  ...
  ie = function (e, a, t, o, n) {
    if ("object" == typeof a) {
      e = e.toLowerCase();
      for (var i, r = a.length, l = 0; l < r; l++)
        if (((i = o ? a[l][o] : a[l]), (i = n ? i[n] : i), t)) {
    ...
    for (t in e)
      e.hasOwnProperty(t) &&
        ...
        i.push(
          "object" == typeof n
            ? he(n, o)
            : encodeURIComponent(o) + "=" + encodeURIComponent(n)
        ));
    return i.join("&");
  };
function ge(o, n, e) {
  let i,
    ...
    u = !1,
    a = !0,
    _ = !n && 0 !== n && "function" == typeof J.requestAnimationFrame;
  if ("function" != typeof o) throw new TypeError("Not a function");
  function f(e) {
    var a = i,
      t = r;
    return (i = r = void 0), (d = e), (l = o.apply(t, a));
  }
  function m(e, a) {
    return _
  ...
  function g() {
    ...
    s = m(
      g,
      ((e = (a = a) - c), (a -= d), (e = n - e), u ? Math.min(e, t - a) : e)
    );
  }
  function v(e) {
  ...
  function y(...e) {
    var a = Date.now(),
      t = h(a);
    if (((i = e), (r = this), (c = a), t)) {
      if (void 0 === s) return (e = c), (d = e), (s = m(g, n)), p ? f(e) : l;
      if (u) return (s = m(g, n)), f(c);
    }
    return void 0 === s && (s = m(g, n)), l;
  }
  return (
    (n = +n || 0),
    e &&
...
let ve = function (e, a) {
    ...
    var o,
      ...
      e = function (e, a, t) {
        var o = J.pageYOffset,
          n = K.documentElement.scrollHeight - J.innerHeight - o;
        e.style.display = a <= o && t <= n ? "" : "none";
      }.bind(null, e, t, a);
    (t || a) &&
      ((ve.handlers = ve.handlers || []),
      (o = ve.handlers).push(e),
      o.length < 2 &&
        ((t = (function (e, a, t) {
          let o = !0,
            n = !0;
          ...
          return (
            ...
            ge(e, a, { leading: o, trailing: n, maxWait: a })
          );
        })(function () {
          for (var e = 0, a = o, t = a.length; e < t; e++) a[e]();
        }, 20)),
...
function ke(o, n, i) {
  if (!ye) return o;
  if ("function" != typeof o || (null != n && "function" != typeof n))
    throw new TypeError("Not a function");
  function r(...e) {
    var a = n ? n.apply(this, e) : e[0],
      t = r.cache;
    return t.has(a)
      ? t.get(a)
      : ((e = o.apply(this, e)),
...
function be(e, a) {
  var t = Math.round,
    ...
    o = "scroll" === a ? Se("w") : 0,
    a = "scroll" === a ? Se("h") : 0;
  return { left: t(e.left + o), top: t(e.top + a) };
}
function we(e) {
  var a = 0,
    t = 0;
...
function xe() {
  y, b("a2a_overlay");
  for (
    var e = b("a2a_modal"), a = f("a2a_modal_body", e), t = 0;
    t < a.length;
    t++
  )
...
let Ae = function () {
  ...
  v = function (e, a) {
    ...
    ("none" == e && Q[a].no_hide) ||
      ...
      Ce(),
      "none" == e
        ? (S["doc_click_listener_" + a].destroy(),
          delete Q[a].doc_click_close_mini,
          o && o[a] && o[a].destroy())
        : n.forEach((e) => {
            e !== a && S["doc_click_listener_" + e] && v("none", e);
          }));
  },
  re = function (e) {
    if (!e) return {};
    for (var a, t = 0, o = e.attributes.length, n = {}; t < o; t++)
      (a = e.attributes[t]).name &&
        "data-" == a.name.substring(0, 5) &&
        (n[a.name.substring(5)] = a.value);
    return n;
  },
  Ee = function (e, a) {
    return e
  ...
  Be = function (e) {
    for (
      var e = e || y, a = Q[e].main_services_col_1, t = a.length, o = 0;
      o < t;
      o++
    )
      a[o].style.display = "";
  ...
  Ne = function () {
    ...
    if ("" !== t)
      for (var o, n = t.split(" "), i = 0; i < a; i++)
        (o = e[i].a2a.serviceNameLowerCase),
          ie(o, n, !1)
            ? (e[i].style.display = "")
  ...
  Le = function (e) {
    var a,
      t,
      o = K.getElementsByTagName("meta"),
      n = o.length;
    if ((a = J.getSelection ? J.getSelection() + "" : a) && "" !== a) return a;
    if (
      Q["n" + w].linkurl === location.href &&
      -1 === ["facebook", "twitter", "linkedin"].indexOf(e)
    )
      for (var i, r, l = 0; l < n; l++)
        if (
          ((i = (i = o[l].getAttribute("name")) ? i.toLowerCase() : ""),
          (r = (r = o[l].getAttribute("property")) ? r.toLowerCase() : ""),
          (i && "description" === i) || (r && "og:description" === r))
        ) {
          t = o[l].getAttribute("content");
          break;
        }
  ...
  ze = function (e, a) {
    ...
    o &&
      (o[e]
        ...
        : o[0] == e
        ? ((n[e] = o[1]), t.push(n))
        : "function" == typeof o && ((n[e] = o), t.push(n)),
  ...
  Me = (e, a, t) => {
    ...
    return (
      void 0 !== n &&
        (n.url && ((a.linkurl = n.url), (a.linkurl_implicit = !1)),
        n.title && ((a.linkname = n.title), (a.linkname_implicit = !1)),
  ...
  Ie = (e) => {
    var a = e.kit || e.node,
      t = re(a)["a2a-url"],
      t =
        (t && ((e.linkurl = t), (e.linkurl_implicit = !1)), re(a)["a2a-title"]),
      t =
  ...
  Oe = function (e) {
    var a = location.href,
      t = K.title || a,
      o = e.parentElement,
      o = Q["n" + (o.a2a_index || o.parentElement.a2a_index || x || w)],
      n = o.type,
      i = e.a2a.safename,
      a = o.linkurl_implicit && a != o.linkurl ? a : o.linkurl,
      r = encodeURIComponent(a).replace(/'/g, "%27"),
      t = o.linkname_implicit && t != o.linkname ? t : o.linkname,
      t = encodeURIComponent(t).replace(/'/g, "%27"),
      l = o.linkmedia,
      l = l ? encodeURIComponent(l).replace(/'/g, "%27") : "",
      s = encodeURIComponent(Le(i)).replace(/'/g, "%27"),
      o =
        !o.track_links || ("page" != n && "mail" != n)
          ? ""
          : "&linktrack=" +
            o.track_links +
            "&linktrackkey=" +
  ...
  s = function (a, t, o) {
    ...
    t &&
      ...
      "show" === a
        ? e ||
          ((l = t),
          (s = n) && Ee(l, "transition-duration") && s.add(i),
  ...
  C = {
    show: function () {
      ...
      "none" === Ee(i, "display") &&
        (s("show", i),
        (C.key_listener = ne(K, "keydown", function (e) {
          var a,
            t = e.which || e.keyCode,
            o = K.activeElement;
          27 == t && r != o ? De(y) : 40 < t && t < 91 && r != o && r.focus(),
            13 == t && o === i && De(y),
            9 === t &&
              (t = b("addtoany") || b("a2a_menu_container")) &&
              ((t = t.querySelectorAll(
                'a[href]:not([disabled]),button:not([disabled]),textarea:not([disabled]),input:not([disabled]),select:not([disabled]),[tabindex]:not([tabindex="-1"])'
              )),
              (a = (t = Array.prototype.slice.call(t).filter(function (e) {
                return (
                  e === i ||
                  (null !== e.offsetParent && !b(n + "_dropdown").contains(e))
                );
              }))[0]),
              (t = t[t.length - 1]),
              e.shiftKey
  ...
  De = function (e) {
    ...
    (E.full_shown = !1),
      ...
      s("hide", t),
      C.hide(function () {
        (o.style.display = n.style.display = "none"),
          t && (t.style.display = "none"),
          (c.showing = !1),
          m(b(a + "_dropdown"))
            ? b(a + "_show_more_less").focus()
            : Q[y].last_focus && Q[y].last_focus.focus();
      });
  },
  E = function () {
    var e = "a2a" + y,
    ...
    Re(y),
      ...
      e.style.height.length &&
        (e.style.height =
          "calc(100% - " + (o.offsetHeight + a.offsetHeight) + "px)"),
      t.focus(),
      d("full");
  },
  S =
    ...
    function (e, a) {
      ...
      Re(y),
        v("block", y),
        (o = [m.clientWidth, m.clientHeight]),
        (n = we("w")),
        (i = we("h")),
        e
          ? ((t = (l = e.a2a_floating) ? "viewport" : "scroll"),
            ...
            s.left - r + o[0] + c > n && (s.left = s.left - o[0] + c - 8),
            ("up" == u.orientation ||
              ("down" != u.orientation &&
                s.top - l + o[1] + d > i &&
                s.top > o[1])) &&
          ...
          : ((m.style.position = (a = a || {}).position || "absolute"),
            (m.style.left = a.left || n / 2 - o[0] / 2 + "px"),
            (m.style.top = a.top || i / 2 - o[1] / 2 + "px")),
        Q[y].doc_click_close_mini ||
          Q[y].no_hide ||
          ((Q[y].doc_click_close_mini =
            ((p = y),
            function (e) {
              ("number" == typeof e.button && 0 < e.button) ||
                (Q[y].last_focus && Q[y].last_focus.focus(), v("none", p));
            })),
          (S["doc_click_listener_" + y] = ne(
            K,
            _,
            Q[y].doc_click_close_mini,
            f
          ))),
        (S.key_listener = S.key_listener || {}),
        (S.key_listener[y] = ne(K, "keydown", function (e) {
          27 != (e.which || e.keyCode) || C.key_listener || v("none", y);
        }));
    }),
  Re =
    ((S.key_listener = X),
      ...
      if (!$e[e]) {
        ...
        if ("mail" != e) {
          for (
            ...
            var m = d[c];
            let e = da(m);
            (f && ie(m[1], f, !0)) || k(() => n.appendChild(se(e))),
              !(_ < u) ||
                (f && ie(m[1], f, !0)) ||
                (k(() => i.appendChild(se(e))), _++);
          }
          k(() => {
            b(o + "_full_services").appendChild(n),
              b(o + "_mini_services").appendChild(i);
          });
        }
        (t = b(o + "_full_services")),
          (s.className = "a2a_i"),
          (a = s.cloneNode()),
          k(() => {
        ...
        for (var c = 0, h = r.email, g = h.length; c < g; c++) {
          ...
          let e = da(v);
          (f && ie(v[1], f, !0)) ||
            k(() => b(o + "_2_col1").appendChild(se(e)));
        }
        k(() => {
          Je(e), He(e);
        }),
          "mail" != e &&
            (l.onkeydown = function (e) {
              ...
              if (13 == e) {
                for (
                  var a, t = 0, o = Q[y].main_services, n = o.length;
                  t < n;
                  t++
                )
                  if ("none" != (a = o[t]).style.display) return a.focus(), !1;
              } else
                27 == e && ("" == l.value && l.blur(), (l.value = ""), Ne());
            }),
          ($e[e] = !0);
      }
    }),
  ...
  He = (e) => {
    ...
    Q[e] &&
      ...
      (t = Q[a]),
      (a = "a2a" + a),
      (t.main_services_col_1 = f("a2a_i", b(a + "_full_services"), "a")),
      (t.main_services = t.main_services_col_1),
      (t.email_services = f("a2a_i", b(a + "_2_col1"), "a")),
...
function Ue(e) {
  let a = c,
    ...
    o = "waiting";
  function n() {
    d("post"), c.show(e), J.removeEventListener(t, n), (a[o] = 0);
  }
  a[o] ||
    ((a[o] = 1),
    J.addEventListener("blur", function e() {
      J.removeEventListener("blur", e), J.addEventListener(t, n);
    }));
}
function We(e, a) {
  var t,
  ...
  (a.innerHTML = ee ? ee.createHTML(e) : e),
    (e = (e = a).querySelectorAll("script")),
    (n = []),
    [].forEach.call(e, function (o) {
      ((t = o.getAttribute("type")) && !i.test(t)) ||
        n.push(function (e) {
          var a, t;
          (a = o),
            (e = e),
    ...
    n.length &&
      (function e(a, t, o) {
        a[(o = void 0 === o ? 0 : o)](function () {
          ++o === a.length ? t() : e(a, t, o);
        });
      })(n, o);
}
let qe = (e, a) => {
  ...
  Ye = (e) => {
    ...
    let i = b(n),
      r =
        (i
          ? (i.textContent = "")
          : (((i = K.createElement("div")).id = n), o.appendChild(i)),
        "");
    n = K.createElement("div");
    (n.className = "a2a_kit a2a_kit_size_32 a2a_default_style"),
      n.setAttribute("data-a2a-url", e.linkurl),
      n.setAttribute("data-a2a-title", e.linkname),
      e.linkmedia && n.setAttribute("data-a2a-media", e.linkmedia),
      (n.style.display = "flex"),
      (n.style.justifyContent = "center");
    for (let e = 0; e < t.length && e < 8; e++)
      r += '<a class="a2a_button_' + t[e] + '"></a>';
    o = r;
    (n.innerHTML = ee ? ee.createHTML(o) : o),
      i.appendChild(n),
      te("page", { target: n }),
      (y = a);
  },
  Ge = (e, a) => {
    ...
    (t.src = ee ? ee.createScriptURL(e) : e),
      a && (t.onload = a),
      D(t),
  ...
  F = {
    lit: function () {
      var e = Z.thanks;
      return !(
        (b("wpadminbar") || (void 0 !== J.wp && J.wp.customize)) &&
        (!e || !e.postShare)
      );
    },
    has: function (e = !1) {
    ...
    set: function (e = !1) {
      ...
      function c() {
        ...
        if ((s && (s.style.display = "none"), l))
          J.postMessage &&
            b("a2a_thanks_ifr").contentWindow.postMessage(
              "a2a_refresh_slot1",
              "*"
            );
        else {
      ...
      function d() {
        var e = J.innerHeight,
          ...
          o = Math.floor((250 * (t - 1)) / 2);
        (l.style.marginTop = e < 360 ? "25px" : "45px"),
          (l.style.transform = a
            ? "translateY(" + o + "px) scale(" + t + ")"
            : "none");
      }
      ((F.lit() && F.has(!0) && !i) || r) &&
        (t && "string" == typeof t.ad && t.ad && 0.5 <= Math.random()
          ? (l && (l.style.display = "none"),
            s ||
              (((i = K.createElement("div")).id = a),
              (i.style.margin = "45px auto 0"),
              n.appendChild(i),
              We(t.ad, i)))
          : e && c());
    },
          ...
          (le.track = (e, a, t) => {
            ...
            n != i &&
              ...
              J.gtag
                ...
                : o || J.dataLayer.push({ event: "AddToAnyShare", ...e }));
          });
    };
    (le.track = p), e(), le.track === p && J.addEventListener("load", e);
  },
  Ve =
    ((le.track = X),
    function (e, a, t) {
      ...
      return null === i
        ? e + (o = /\?/.test(e) ? "&" : "?") + a + "=" + t
        : ((o = i[0].charAt(0)), e.replace(n, o + a + "=" + t));
    }),
  Je = (e) => {
    ...
    if ("page" === a && Z.add_services) {
      ...
      for (var d, c = 0; c < a; c++)
        e[c] &&
          ((t += 1),
          (d = [e[c].name, e[c].safe_name, null, null, {}, null, e[c].icon]),
          (d = da(d)),
          (s = se(d)),
          o.insertBefore(s, o.firstChild),
          (s = se(d)),
    ...
    if ((a = f("a2a_i", n, "a")).length > t)
      for (var c = 0, p = a.length; c < p - t; c++) n.removeChild(n.lastChild);
  },
  Ke = function (e, a, t) {
    var o = parseInt(Q[a].num_services),
    ...
    if (e) {
      ...
      if (0 < s.length) {
        for (var p, c = 0; c < s.length; c++)
          (p =
            ie(s[c].a2a.safename, l, !0, "a2a", "safename") ||
            ((p = s[c].a2a),
            (p = da([
              p.servicename,
              p.safename,
        ...
        if ((l = f("a2a_i", i, "a")).length > o)
          for (var c = 0, u = l.length; c < u - o; c++)
  ...
  Xe = function (e) {
    var a, t, o, n, i, r, l;
    _ ||
      ((_ = K.createElement("style")).setAttribute("type", "text/css"),
      D(_),
      O.appendChild(_),
      y,
      (a = (l = Z).color_main || "EEE"),
      (t = l.color_bg || "FFF"),
      (o = l.color_border || "CCC"),
      (i = l.color_link_text || "0166FF"),
      (r = l.color_link_text_hover || "2A2A2A"),
      (n = l.color_link_text || "2A2A2A"),
      (r =
        ...
        a +
        ";text-decoration:none}.a2a_menu label.a2a_s_find{background-size:24px;height:24px;left:8px;pointer-events:auto;position:absolute;top:7px;width:24px}.a2a_menu label.a2a_s_find svg{background-color:#" +
        t +
        "}.a2a_menu label.a2a_s_find svg path{fill:#" +
        (i = l.color_border || o) +
  ...
  Ze = function () {
    ...
    for (
      ...
      (e = ".a2a_s_" + i[r][2]),
        ...
        o ? t.insertRule(e + "{" + a + "}", 0) : n && t.addRule(e, a, 0);
    {
      var s = Z.static_server,
        c = K.createElement("link"),
        d = s != u ? s + "/" : u + "/svg/";
      (c.rel = "stylesheet"),
        (c.href = d + "icons.39.svg.css"),
        O.appendChild(c);
    }
    Ze = p;
  },
  ...
  ta = "</svg>",
  oa = (e, a) => e.replace(/#FFF/gi, a),
  na = (e, a, t) => {
    e = t ? oa(e, t) : e;
    t = aa + e + ta;
    a.innerHTML = ee ? ee.createHTML(t) : t;
  },
  ia = (e, a, t) => {
    var o = j[e];
    -1 !== i.indexOf(e) &&
  ...
  la = () => {
    ...
    Qe ||
      ...
      D(e),
      (t = t + "icons.39.svg.js"),
      (e.src = ee ? ee.createScriptURL(t) : t),
  ...
  ca = {
    ...
    set: (e, a) => {
      if (a) for (var t in e) j[t] = e[t];
      else j = e;
      for (let e = 0, a = sa.length; e < a; e++) {
        var o = sa[e],
          { name: n, node: i, color: r, done: l } = o,
          n = j[n];
        n && !l && (na(n, i, r), (o.done = !0));
      }
    },
  },
  da = (e) => {
  ...
  se = (e, a, s) => {
    ...
    (e.safename = d),
      (e.servicename = c),
      (e.serviceNameLowerCase = c.toLowerCase()),
      (e.serviceIcon = o),
      (e.serviceColor = n),
      (e.serviceType = i.type),
      i.type && (e.stype = i.type),
      i.src && (e.js_src = i.src),
      i.url && (e.url = i.url),
      i.pu && (e.popup = 1),
      i.na && (e.na = 1),
      i.media && (e.media = 1),
      a ||
        ((a = "<span></span>" + c + " "),
        (p.innerHTML = ee ? ee.createHTML(a) : a),
        (a = p.firstChild),
        (u = "a2a_svg a2a_s__default"),
        (m = (_ = (f = Z.icon_color) ? f.split(",", 2) : X) ? _[0] : X),
        (_ = _ ? (null == (t = _[1]) ? void 0 : t.trim()) : X),
        r && (e.customserviceuri = r),
        l
          ? ((a.style.backgroundImage = "url(" + l + ")"), (a.className = u))
          : f
          ? ((a.className = u + " a2a_s_" + o),
            m && "unset" != m
    ...
    return (
      "js" === e.stype
        ? ne(p, "click", m)
        : (ne(p, "mousedown", m), ne(p, "keydown", m)),
      ne(p, "click", (e) => {
        var a,
          t,
          o = s || Q["n" + w],
          n = {
            media: o.linkmedia,
            mediaNode: null == (n = o.kit) ? void 0 : n.a2a_mediaNode,
            node: p,
            service: c,
            serviceCode: d,
            title: o.linkname,
            ...
            !i.popup ||
              ...
              J.open(
                ...
                "toolbar=0,personalbar=0,resizable,scrollbars,status,width=650,height=550,top=" +
                  (550 < l ? Math.round(l / 2 - 275) : 40) +
                  ",left=" +
                  Math.round(screen.width / 2 - 325)
              )),
            i.js_skip);
        (!i.externalJS && !i.literalJS) ||
          n ||
          l ||
          ((n = i).literalJS
            ? ((a = K.createElement("script")),
              D(a),
              (t = ee ? ee.createScript(n.literalJS) : n.literalJS),
              (a.textContent = t),
              O.appendChild(a))
            : n.externalJS && Ge(n.externalJS)),
          r && !l && g(e),
          l && delete i.js_skip,
          le.track(c, d, o.linkurl);
      }),
      p
    );
  },
  pa = () => {
    ...
    var e,
      ...
      o = ie(a, t, !0);
    o || (-1 != (e = a.indexOf("-")) && (o = ie(a.substring(0, e), t, !0)));
    let n = !("en-us" == a || !o) && o;
    return (pa = () => n), n;
  },
  ua = function () {
    ...
    for (var n, i, r, l = 0, s = e.length; l < s; l++)
      (r =
        (r = (n = e[l]).getAttribute("data-a2a-localize")) &&
        r.split(",", 2)) &&
        ((i = r[0]),
        (r = a[(r = r[1])] || t[r] || ""),
        "inner" === i
          ? (n.innerHTML = r.replace(/\</g, "&lt;"))
          : "label" === i
          ? n.setAttribute("aria-label", o(r))
          : "title" === i && n.setAttribute("title", o(r)));
  },
  _a = {
    Share: "Share",
    Save: "Save",
  ...
  fa = function (e) {
    if (((y = Z.menu_type || e), !Q[y] && !J["a2a" + y + "_init"])) {
      (Q[y] = {}),
        (J.a2a_show_dropdown = S),
        (J.a2a_miniLeaveDelay = Ae),
        (J.a2a_init = te);
      var a,
        t = Q[y],
        e = "feed" == y ? "feed" : "page",
      ...
      (i = pa()) &&
        "custom" != i &&
        Ge(o.static_server + "/locale/" + i + ".js", function () {
          (o.localize = J.a2a_localize), ua();
        });
      var n,
        i = y,
        e = H[e],
        ...
        c = Z;
      K.createElement("a");
      var d = (p = (p = c.icon_color) && p.split(",", 2)) && p[0],
        p = p && p[1],
        u = "a2a_svg a2a_s__default a2a_s_",
        d = d && "unset" != d ? d : "#0166ff",
        _ =
      ...
      (m = c.localize =
        {
          Share: m.Share || f.Share,
          Save: m.Save || f.Save,
          Subscribe: m.Subscribe || f.Subscribe,
          Email: m.Email || f.Email,
          Bookmark: m.Bookmark || f.Bookmark,
          ShowAll: m.ShowAll || f.ShowAll,
          ShowLess: m.ShowLess || f.ShowLess,
          FindAnyServiceToAddTo:
            m.FindAnyServiceToAddTo || f.FindAnyServiceToAddTo,
          PoweredBy: m.PoweredBy || f.PoweredBy,
          AnyEmail: "Any email",
          ShareViaEmail: m.ShareViaEmail || f.ShareViaEmail,
          SubscribeViaEmail: m.SubscribeViaEmail || f.SubscribeViaEmail,
          BookmarkInYourBrowser:
            m.BookmarkInYourBrowser || f.BookmarkInYourBrowser,
          BookmarkInstructions:
            m.BookmarkInstructions || f.BookmarkInstructions,
          AddToYourFavorites: m.AddToYourFavorites || f.AddToYourFavorites,
          SendFromWebOrProgram:
            m.SendFromWebOrProgram || f.SendFromWebOrProgram,
          EmailProgram: m.EmailProgram || f.EmailProgram,
          More: m.More || f.More,
          ThanksForSharing: m.ThanksForSharing || f.ThanksForSharing,
          ThanksForFollowing: m.ThanksForFollowing || f.ThanksForFollowing,
          Close: m.Close || f.Close,
        })))
        m[n] = m[n].replace(/\</g, "&lt;");
      h ||
        (l =
        ...
        (r +=
          ...
          ("feed" == y ? m.Subscribe : m.Share) +
          '" data-a2a-localize="title,' +
          ("feed" == y ? "Subscribe" : "Share") +
          '"><div class="a2a_full_header"><div id="a2a' +
          y +
          '_find_container" class="a2a_menu_find_container"><label for="a2a' +
          y +
          '_find" id="a2a' +
          y +
          '_find_icon" class="a2a_svg a2a_s_find"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><title>' +
          m.FindAnyServiceToAddTo +
          '</title><path fill="#CCC" d="M19.7 18.2l-4.5-4.5c.7-1.1 1.2-2.3 1.2-3.6 0-3.5-2.8-6.3-6.3-6.3s-6.3 2.8-6.3 6.3 2.8 6.3 6.3 6.3c1.4 0 2.6-.4 3.6-1.2l4.5 4.5c.6.6 1.3.7 1.7.2.5-.4.4-1.1-.2-1.7zm-9.6-3.6c-2.5 0-4.5-2.1-4.5-4.5 0-2.5 2.1-4.5 4.5-4.5 2.5 0 4.5 2.1 4.5 4.5s-2 4.5-4.5 4.5z"/></svg></label><input id="a2a' +
          y +
          '_find" class="a2a_menu_find a2a_localize" type="text" autocomplete="off" title="' +
          m.FindAnyServiceToAddTo +
          '" data-a2a-localize="title,FindAnyServiceToAddTo"></div></div><div class="a2a_full_services" id="a2a' +
          y +
        ...
        (r += "</div>"),
        h
          ? ((i = ee ? ee.createHTML(r) : r),
            I.insertAdjacentHTML("beforeend", i))
          : ((d = l + r),
            (c = ee ? ee.createHTML(d) : d),
            I.insertAdjacentHTML("afterbegin", c)),
        (f = b(s + "_dropdown")) &&
          (ne(f, "mouseenter", Ce), Z.onclick || ne(f, "mouseleave", Ae)),
        (p = b(s + "_find")) &&
          (ne(b(s + "_find_icon"), "click", Te),
          ne(p, "click", Te),
          ne(p, "keyup", Ne)),
        (Q[y].services = e),
        ne(b("a2a_overlay"), "click", function (e) {
          De(y);
        }),
        "mail" != y &&
          ne(b(s + "_show_more_less"), "click", function (e) {
            g(e), Fe();
          }),
        le(),
        L(T);
    ...
    qe(o, (e) => {
      i.focus(),
        ...
        K.execCommand &&
          ...
          setTimeout(() => {
            (t.style.display = o.style.display = n.style.display = "none"),
              E.full_shown ? E() : De("page");
          }, 700));
    });
    var r = () => {
...
Pe = J.a2a.core;
"function" == typeof Pe ? Pe(ma) : (J.a2a.core = ma);
export {
  J as win,
  K as doc,
  p as noop,
