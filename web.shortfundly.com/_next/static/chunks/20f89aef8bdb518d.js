(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    class p extends c.default.Component {
      ...
      render() {
        return this.state.error && !d
          ? (0, i.jsxs)(i.Fragment, {
              children: [
                (0, i.jsx)(l.HandleISRError, { error: this.state.error }),
          ...
          (o.nextTick = function (e) {
            ...
            if (arguments.length > 1)
              for (var r = 1; r < arguments.length; r++)
                t[r - 1] = arguments[r];
            a.push(new p(e, t)), 1 !== a.length || s || c(d);
          }),
        ...
        !(function e(t, r, n, i, c) {
          ...
          if (S(t))
            for (var _ = 0; _ < t.length; _++)
              (f = p + M((i = t[_]), _)), (d += e(i, r, n, f, c));
          else if (
            "function" ==
            typeof (_ =
              null === (l = t) || "object" != typeof l
                ? null
                : "function" == typeof (l = (g && l[g]) || l["@@iterator"])
                ? l
                : null)
          )
            for (t = _.call(t), _ = 0; !(i = t.next()).done; )
              (f = p + M((i = i.value), _++)), (d += e(i, r, n, f, c));
          else if ("object" === f) {
    ...
    var n = {
      ...
      getSelectedLayoutSegmentPath: function () {
        return function e(t, r, n = !0, o = []) {
          ...
          if (!i) return o;
          let c = u(i[0]);
          return !c || c.startsWith(l) ? o : (o.push(c), e(i, r, !1, o));
        };
      },
  ...
  (e, t, r) => {
    ...
    let u = e.r(76963),
      i = e.r(68391),
      c = "undefined" == typeof window ? e.r(62266).actionAsyncStorage : void 0;
